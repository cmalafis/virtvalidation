...
//
// Header aliasing, row-to-payload mapping, and CSV/XLSX parsing live
// in src/utils/parseRVTools.js so the per-vCenter upload flow in
// VCenterSources.jsx can share them.
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
            ...
            <Link to="/sources/targets" title="Manage OCP target clusters" style={{
              display: "inline-flex", alignItems: "center", gap: 8,
              background: "transparent", border: "1px solid #3a3a55",
              color: "#aaaacc", textDecoration: "none",
              padding: "10px 16px", fontSize: 12,
            ...
            <Link to="/mappings" title="Resource mappings (network / storage / namespace)" style={{
              display: "inline-flex", alignItems: "center", gap: 8,
              background: "transparent", border: "1px solid #3a3a55",
              color: "#aaaacc", textDecoration: "none",
              padding: "10px 16px", fontSize: 12,
